    ...
    return (
        <div className={'login outside-container' + formState}>
            <form className="form-container">
                <FontAwesomeIcon id='close' onClick={() => {dispatch(setLogInFormHidden()); fieldClear(); setTimeout(() => {dispatch(setLogInFormInitial())},1000)}} icon={faArrowRight}></FontAwesomeIcon>
