    ...
    return (
        <div className={'signup outside-container' + formState}>
            ...
            <form className="form-container">
                ...
                {!success && <FontAwesomeIcon id='close' onClick={() => { dispatch(setSignUpFormHidden()); fieldClear(); setErrFlag(false); setTimeout(() => { dispatch(setSignUpFormInitial()) }, 1000) }} icon={faArrowRight}></FontAwesomeIcon>}
                {!success && <div className="inputs email">
                ...
                {!success && <div className="inputs username">
                ...
                {!success && <div className="inputs password">
                ...
                {!success && <div className="inputs confirmpassword">
                ...
                {!success && <PrimaryButton text='Sign Up' color='blue' function={signUpFunction} />}
            </form>
        </div>
    )
}
